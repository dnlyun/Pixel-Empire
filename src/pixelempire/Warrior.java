...
abstract class Warrior extends BattleItem implements Fight {
    ...
    /**
     * moveForward Method that moves character based on their speed and elapsed
     * time
     *
     * @param Time elapsed
     */
    ...
    /**
     * checkForRedEnemy Method to check whether red enemy is in range
     *
    ...
    /**
     * checkForBlueEnemy Method to check whether red enemy is in range
     *
     * @param Takes map object, and coordinates
     * @return Either returns the position in range, zero, or returns a negative
     */
    ...
    /**
     * checkForAlly Method that checks map region is the ally region
     *
