...
public class GameServer implements Runnable {
    ...
    /**
     * CreateServer Create the server given the IP Address and port number
     */
    ...
    /**
     * ServerRequest Listen for other clients attempting to connect and accept
     * their connection
     */
    ...
    /**
     * Run Overridden method, tries running server while the game has not been
     * won, and there are fewer than 10 errors, else closes socket server
     */
    @Override
    public void run() {
