...
public class GameWindow implements Runnable {
    ...
    GameWindow(String ip, int port) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            archer.setHealth(5); //The less health a warrior has, the less effective their attack will be
            map.setItem(archer);
        }
    ...
    /**
     * run Overridden method, connects and runs game
     */
    @Override
    public void run() {
        try {
    ...
    /**
     * render Draw elements on the screen
     *
    ...
    /**
     * drawY Draws y-coordinate based on different cases
     *
    ...
    /**
     * checkForAlly Checks whether map region is ally region
     *
    ...
    /**
     * checkForWin Checks which player has won
     */
    ...
    /**
     * setFightImage depending on team, chooses characters' colour
     *
    ...
    /**
     * setMoveImage depending on team, moves character image
     *
     * @param BattleItem type object
     * @return BattleItem type object
     */
    ...
    /**
     * overlayRender draws on the game window
     *
     * @param Graphics object
     */
    ...
    /**
     * dragRender Allows for drag and drop of characters
     *
     * @param Graphics object
     */
    ...
    /**
     * endRender Drawing at the end based on victory or defeat
     *
     * @param Graphics object
     */
    ...
    public class GamePanel extends JPanel {
        ...
        /**
         * paintComponent Overridden method that draws and updates
         *
         * @param Graphics object
         */
        @Override
    ...
    public class DragPanel extends JPanel implements MouseListener {
        ...
        /**
         * mouseReleased Checks where mouse was released and places appropriate
         * character there
         *
         * @param MouseEvent object
         */
    ...
    public class ButtonListener implements ActionListener {
        ...
        /**
         * actionPerformed Checks what button is clicked and fulfills
         * appropriate action
         *
